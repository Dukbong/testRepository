...
public class Member {
	...
	public Member(int uesrNo, String userId, String userPwd, String userName, String phone, String email,
			String address, String interest, Date enrollDate, Date modifyDate, String status) {
		super();
		this.uesrNo = uesrNo; // Sequence
		this.userId = userId;
...
//		this.status = status;
	...
	public String toString() {
		return "Member [uesrNo=" + uesrNo + ", userId=" + userId + ", userPwd=" + userPwd + ", userName=" + userName
